...
import { ArrowRight, Building, Star, User } from "lucide-react";
...
const customerStoriesData: CustomerStory[] = [
  {
    ...
    testimonial:
      "DeepFin的AI解决方案帮助我们降低了40%的运营成本，同时提高了客户满意度。他们的团队非常专业，从需求分析到实施部署，全程提供了优质的支持。",
    challenge:
      "我们面临的最大挑战是如何在保证安全性的同时，提高金融交易的处理速度和准确性。",
    solution:
      "DeepFin为我们定制了一套智能风控系统，利用深度学习算法实时分析交易数据，精准识别异常行为。",
    result:
      "实施DeepFin的解决方案后，我们的交易处理速度提高了60%，风险检测准确率达到99.7%，客户满意度提升了35%。",
    rating: 5,
    industry: "金融服务",
  },
  {
    ...
    logo: "/lovable-uploads/0bc90c42-9bb0-4ae5-a955-1714ac9404cb.png",
    testimonial:
      "DeepFin的跨境支付解决方案彻底改变了我们的国际业务流程，过去需要3-5天的跨境交易现在只需几分钟就能完成。",
    challenge:
      "国际贸易中的跨境支付流程复杂，周期长，成本高，严重影响了我们的资金周转效率。",
    solution:
      "DeepFin为我们提供了基于区块链的跨境支付平台，结合AI技术优化汇率和手续费，大大简化了支付流程。",
    result:
      "交易时间从平均4天缩短至15分钟，节省了30%的手续费，业务量在六个月内增长了45%。",
    rating: 5,
    industry: "国际贸易",
  },
  {
    ...
    logo: "/lovable-uploads/0bc90c42-9bb0-4ae5-a955-1714ac9404cb.png",
    testimonial:
      "DeepFin的智能供应链金融解决方案让我们的小微供应商也能享受到优质的金融服务，极大地提升了整个供应链的健康度。",
    challenge:
      "我们有大量的小微供应商难以获得传统银行融资，导致供应链不稳定，影响了我们的正常经营。",
    solution:
      "DeepFin基于我们的交易数据，开发了供应链金融平台，为小微供应商提供精准的信用评估和快速融资服务。",
    result:
      "供应商融资成本下降25%，供应链稳定性提高50%，供应商满意度达到历史新高。",
    rating: 4,
    industry: "零售",
  },
  {
    ...
    logo: "/lovable-uploads/0bc90c42-9bb0-4ae5-a955-1714ac9404cb.png",
    testimonial:
      "DeepFin的医疗AI支付系统不仅简化了我们的收费流程，还通过智能化的保险理赔服务大大减轻了患者的负担。",
    challenge:
      "医疗收费和保险理赔流程繁琐，既消耗医院资源，也增加了患者的负担。",
    solution:
      "DeepFin开发了智能医疗支付系统，结合OCR和NLP技术自动处理医疗单据，实现了与保险公司的无缝对接。",
  ...
  },
  {
    ...
    logo: "/lovable-uploads/0bc90c42-9bb0-4ae5-a955-1714ac9404cb.png",
    testimonial:
      "作为一家快速成长的教育科技公司，DeepFin的金融云服务让我们能够灵活应对各种财务挑战，支持我们的业务扩张。",
    challenge:
      "业务快速扩张带来的财务管理复杂性增加，传统财务系统难以适应多元化业务模式。",
    solution:
      "DeepFin提供了可扩展的金融云服务，包括智能会计、预算管理和现金流预测，支持多币种、多实体的复杂业务场景。",
  ...
  },
  {
    ...
    position: "运营共享智能化项目总监",
    category: "石油化工",
    logo: "/lovable-uploads/zsylogo.png",
    testimonial:
      "DeepFin的智能财务审核解决方案帮助我们节省了大量人工审核的时间，提高了运营共享的制证效率，为公司的财务智能化提供了有力支持。",
    challenge:
      "集团财司承接各地市分公司票据集中化业务，存在大量非标准票据，长久以来依赖人工审核，耗时耗力。",
    solution:
      "依托DEEPFIN，结合语言大模型的推理能力，实现了审核规则自动生成，关键信息精确提取，关联事由准确判断。",
    result: "在200类业务单据中落地了智能审核流程，平均节约人工审核时常50%。",
    rating: 5,
    industry: "能源",
  },
  {
    ...
    logo: "/lovable-uploads/0bc90c42-9bb0-4ae5-a955-1714ac9404cb.png",
    testimonial:
      "DeepFin的智能工厂金融方案将我们的生产数据与金融服务无缝结合，大大提高了资产利用效率和投资回报率。",
    challenge:
      "传统制造业数字化转型面临资金压力，需要更精准的成本控制和更高效的资产管理。",
    solution:
      "DeepFin基于物联网数据，开发了工业资产金融管理系统，包括设备租赁、保险和预测性维护的金融优化方案。",
